...
class AppContext private constructor(
    ...
    companion object {
        ...
        fun bootstrap(dataDir: Path = resolveDataDir()): AppContext {
            ...
            return AppContext(store, repos, reviews, publications, comments, notes, findings, approvals, jobs, guidelines, replies, seenPrs, prCache, prLoader, prefs, engine, auto, notifier, persons, commitStats, statsCollector, reviewStats)
        }
